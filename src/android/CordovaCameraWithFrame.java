...
public class CordovaCameraWithoutFrame extends CordovaPlugin {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (cameraIntent.resolveActivity(cordova.getActivity().getPackageManager()) != null) {
                    cordova.startActivityForResult(CordovaCameraWithoutFrame.this, cameraIntent, CAMERA_REQUEST);
                } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == cordova.getActivity().RESULT_OK) {
            ...
            String encodedImage = encodeImage(photo); // Implement method to encode bitmap to base64
